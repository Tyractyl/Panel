...
use Tyractyl\Tests\Integration\TestResponse;
use Tyractyl\Tests\Integration\IntegrationTestCase;
use Illuminate\Database\Eloquent\Model as EloquentModel;
use Tyractyl\Transformers\Api\Client\BaseClientTransformer;
...
abstract class ClientApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    protected function assertJsonTransformedWith(array $data, Model|EloquentModel $model)
    {
        ...
        $transformer = sprintf('\\Tyractyl\\Transformers\\Api\\Client\\%sTransformer', $reflect->getShortName());
